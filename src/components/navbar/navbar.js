...
x:0,opacity:1,duration:2,stagger:{amount:1},ease: "power3.out",
         },"frstview")
  ...
  <ShoppingCartIcon style={{color:"white"}} sx={{fontSize:30}} onClick={()=>{
    navigate("/cart")
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    navigate("/")
                }} aria-current="page" href="#" style={{ color: theme.palette.common.white  }} >Home</a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" style={{ transition:"0.5 ease",border: "none", textAlign: "center" }}>
                                ...
                                <li class="dropdown-item" ><a onClick={()=>{
                                    navigate('/products/napoli?filter=all')
                                }} style={{ color: "white", backgroundColor: isHovered2 ? "grey" : "transparent" }} class="dropdown-item" href="#" onMouseLeave={() => {
                                    setIsHovered2(false)
                                }}
                                    onMouseEnter={() => {
                                        setIsHovered2(true)
